                ...
                {items.map((item) => (
                    ...
                    >
                        ...
                        <div className="p-5 flex flex-col flex-grow border-gray-50 bg-gray-50/30">
                            <h3 className="font-bold text-gray-800 text-lg mb-2 line-clamp-2 leading-tight" title={item.name}>
                                {item.name}
                            </h3>
                            ...
                            <div className="flex items-center justify-between mt-auto">
                                ...
                                <div className="flex items-center gap-1.5 bg-yellow-50/80 px-2.5 py-1.5 rounded-lg border border-yellow-100">
                                    ...
                                    <span className="text-xs font-medium text-yellow-600/70 ml-1">({item.reviewCount})</span>
                                </div>
                            </div>
                        </div>
                    </div>
